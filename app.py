...
class ServiceForm(FlaskForm):
    ...
    service_name = SelectField('Service Name', choices=[('Electrician', 'Electrician'), ('Plumber', 'Plumber')], validators=[DataRequired()])
...
def book_service(service_id):
    ...
    if service:
        return f"Booking service: {service[3]}"  # Displaying service_provider_name for simplicity
    else:
